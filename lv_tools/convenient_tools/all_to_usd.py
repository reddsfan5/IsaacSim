...
input_path = '/home/ubuntu/lxd/usd_file/glb/airship.glb'
output_path = '/home/ubuntu/lxd/usd_file/glb/airship.usd'
asyncio.ensure_future(convert_asset_to_usd(input_path, output_path))
