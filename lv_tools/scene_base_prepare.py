...
asset_usd_path = '/data2/isaacsim/assets/converted_usd/symmetric_cylinder/Gangzhu_top_003.usd'
env_usd_path = '/data2/isaacsim/scene/dining_rooms/dining_room_6/dining_room_6.usdc'
material_usd_path = '/data2/isaacsim/materials/material_aggregation_usd/moto_poliigon_metal_v7.usd'
